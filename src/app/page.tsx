  ...
  <div id="home" data-section="home">
      ...
      avatars={[
        ...
        },
        {
          ...
          alt: "Confident asian businesswoman showing thumbs up standing near entrance of her cafe or restaurant",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-woman-drinking-coffee-urban-cafe_158595-685.jpg",
          alt: "Young woman drinking coffee in urban cafe",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-woman-sitting-indoor-urban-cafe_158595-670.jpg",
          alt: "Young woman sitting indoor in urban cafe",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-interracial-young-couple-sitting-outdoor-cafe_23-2148151923.jpg",
          alt: "Portrait of interracial young couple sitting at outdoor cafe",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Authentic recipes preserved through generations for that signature nostalgic taste.",
          imageSrc: "http://img.b2bpic.net/free-photo/carrot-soup-with-garlic-bread-bowl-garnished-with-cheese_140725-6535.jpg",
        },
        {
          tag: "Ambiance",
          title: "Amber Warmth",
          subtitle: "Old-world lighting",
          description: "Sunlight filtered through wooden lattices, creating a calm and intimate dining atmosphere.",
        ...
        },
        {
          ...
          subtitle: "Classic care",
          description: "Attentive, old-school hospitality that makes every guest feel like a regular.",
          imageSrc: "http://img.b2bpic.net/free-photo/view-vintage-metallic-cutlery_23-2150315232.jpg",
        },
      ]}
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "120",
          imageSrc: "http://img.b2bpic.net/free-photo/grilled-salmon-steak-with-grilled-vegetables-lemon-rosemary-homemade-lemonade-bread-table_140725-10845.jpg",
        },
        {
          id: "p2",
          brand: "Heritage",
        ...
        },
        {
          ...
          rating: 4,
          reviewCount: "65",
          imageSrc: "http://img.b2bpic.net/free-photo/fried-meat-with-vegetables-white-bread_140725-2110.jpg",
        },
        {
          id: "p6",
          brand: "Bakery",
      ...
      metrics={[
        {
          ...
          value: "150+",
          title: "Daily Guests",
          description: "Welcoming friends old and new.",
          icon: Users,
        },
        {
          id: "m2",
          value: "500+",
          title: "Recipes",
          description: "Curated culinary traditions.",
          icon: Utensils,
        },
        {
          id: "m3",
          value: "20",
          title: "Awards",
          description: "Recognized for quality.",
          icon: Award,
        },
      ]}
  ...
  <div id="testimonial" data-section="testimonial">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Gallery Central",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-vector/watercolor-patterns-pirate-elements_23-2147629461.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "For brunch and weekends, we highly recommend booking in advance.",
        },
        {
          id: "q2",
          title: "Are you pet friendly?",
          content: "Our heritage indoor space is strictly for human patrons, but our courtyard is welcoming.",
        },
        {
          id: "q3",
          title: "Is the menu gluten-free?",
          content: "We offer several traditional dishes that can be prepared with gluten-free ingredients.",
        },
      ]}
